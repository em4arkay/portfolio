    ...
    >
      ...
      <div className="basis-3/5 z-10 mt-16 md:mt-32 flex justify-center md:order-2">
        {isAboveLarge ? (
          ...
          <img
            alt="profile"
            className="pl-14 z-10 w-full max-w-[300px] md:max-w-[600px]"
            src="../assets/profile-image.png"
          />
        )}
      </div>
      ...
      <div className="z-30 basis-2/5 mt-12 md:mt-32">
        ...
        >
          <p className="text-5xl font-sofiasans z-10 text-center md:text-start">
            Natchanon {""}
            <span
              className="xs:relative xs:text-red xs:font-semibold font-sofiasans z-20"
            >
              Danual
            </span>
          </p>

          <p className="mt-10 mb-7 text-sm text-center md:text-start font-firacode">
              providing services for web developing, programming.
        ...
        >
          <AnchorLink
            className="bg-gradient-rainblue-h text-deep-blue rounded-sm py-3 px-7 font-sofiasans
